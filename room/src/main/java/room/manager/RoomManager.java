...
public class RoomManager {
	...
	public void getAllRoomTable(RoomProto.AckGetRoomList.Builder ack) {
		...
		ConcurrentHashMap<String, ServerProto.RoomTableInfo> value;
		for (Map.Entry<Integer, ConcurrentHashMap<String, ServerProto.RoomTableInfo>> roomTable : roomTables.entrySet()) {
