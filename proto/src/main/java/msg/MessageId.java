...
public class MessageId {
	...
	@ClassType(value = ModelProto.ReqHeart.class, common = true,
			serverTypes = { ServerType.Game, ServerType.Center , ServerType.Room })
	public static final int HEART = 1;//心跳
	@ClassType(value = ModelProto.AckHeart.class, common = true,
			serverTypes = { ServerType.Game, ServerType.Gate, ServerType.Hall, ServerType.Room })
	public static final int HEART_ACK = 2;//回复

	@ClassType(value = ModelProto.ReqRegister.class, common = true,
			serverTypes = { ServerType.Game, ServerType.Center , ServerType.Room })
	public static final int REQ_REGISTER = 3;//请求注册

	@ClassType(value = ModelProto.AckRegister.class, common = true,
			serverTypes = { ServerType.Game, ServerType.Gate, ServerType.Hall, ServerType.Room })
	public static final int ACK_REGISTER = 4;//注册回复

	@ClassType(value = ModelProto.NotRegisterInfo.class, common = true,
			serverTypes = { ServerType.Gate, ServerType.Hall, ServerType.Room })
	public static final int REGISTER_NOTICE = 5;//注册通知


	@ClassType(value = ModelProto.NotServerBreak.class, common = true,
			serverTypes = { ServerType.Gate, ServerType.Hall, ServerType.Room })
	public static final int BREAK_NOTICE = 6;//服务掉线通知


	@ClassType(value = ModelProto.ReqServerInfo.class, common = true, serverTypes = { ServerType.Center })
	public static final int REQ_SERVER = 7;//服务信息请
	@ClassType(value = ModelProto.AckServerInfo.class, common = true,
			serverTypes = { ServerType.Gate, ServerType.Hall, ServerType.Room })
	public static final int ACK_SERVER = 8;//服务信息回复

	@ClassType(value = ModelProto.NotBreak.class, common = true, serverTypes = { ServerType.Game , ServerType.Room })
	public static final int NOT_BREAK = 9;//通知玩家掉线

	@ClassType(GateProto.BroadCast.class)
