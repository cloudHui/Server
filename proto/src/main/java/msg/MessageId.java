...
public class MessageId {
	...
	@ClassType(value = ModelProto.ReqHeart.class,
			messageTrans = { MessageTrans.GameServer, MessageTrans.CenterServer, MessageTrans.RoomServer },
			des = "心跳")
	public static final int HEART = 1;

	@ClassType(value = ModelProto.AckHeart.class,
			messageTrans = { MessageTrans.GameServer, MessageTrans.GateServer, MessageTrans.HallServer, MessageTrans.RoomServer },
			des = "心跳回复")
	...
	@ClassType(value = ModelProto.NotRegisterInfo.class,
			messageTrans = { MessageTrans.GateServer, MessageTrans.HallServer, MessageTrans.RoomServer },
			des = "注册通知")
	...
	@ClassType(value = ModelProto.NotBreak.class, messageTrans = { MessageTrans.GameServer, MessageTrans.RoomServer }, des = "通知玩家掉线")
